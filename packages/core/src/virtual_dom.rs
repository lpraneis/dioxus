...
pub struct VirtualDom {
    ...
    pub(crate) non_sync_receiver: crate::innerlude::Receiver<SchedulerMsg>,
}
...
impl VirtualDom {
        ...
        P: 'static,
    {
        ...
        let non_sync_receiver = crate::innerlude::Receiver::default();
        let sender: crate::innerlude::Sender<'static, SchedulerMsg> =
